...
userPhone,userAge,userPassword,
userRePassword,userNameAlert,
userEmailAlert,userPhoneAlert,userAgeAlert,
userpasswordAlert,userRepasswordAlert;
...
<div class="col-md-6 col-lg-3 my-3 searche shadow">
...
<div class="col-md-6 col-lg-3 my-3 searche  shadow">
    <div class="movie shadow rounded position-relative">
        <div onclick=(filterByArea('${arr[i].strArea}')) class="post ">
            <i class="fa fab-solid fa-city fa-3x"></i>
...
let str = `
<div class="col-md-4  searche text-white">
                <img class="w-100" src="${meal.strMealThumb}" alt=""
                    srcset=""><br>
                <h1>${meal.strMeal}</h1>
            </div>
            <div class="col-md-8  searche text-white text-left">
                <h2>Instructions</h2>
...
if (listBy == "contact") {
    ...
    row.innerHTML = `
    <section id="contact" class="container searche w-75 mx-auto mb-5 ">
    <div class="p-2">
        <h2 class="text-light mb-5">ContacUs...</h2>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <input class="form-control shadow m-2" onkeyup="validation()" id="name"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input onkeyup="validation()" class="form-control m-2" id="email" placeholder="Enter Email">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input onkeyup="validation()" class="form-control m-2" id="phone" placeholder="Enter phone">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input onkeyup="validation()" class="form-control m-2" id="age" placeholder="Enter Age">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input onkeyup="validation()" class="form-control m-2" type="password" id="password"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input onkeyup="validation()" class="form-control m-2" type="password" id="rePassword"
        ...
        <button type="submit" disabled id="submitBtn" class="btn btn-outline-danger m-2">Submit</button>
    </div>
...
if ($(document).scrollTop()) {
    $(".bok").css("backgroundColor", "#0D0D0D")
}
})
